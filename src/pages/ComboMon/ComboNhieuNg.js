...
class ComboNhieuNg extends Component {
  ...
  constructor(props){
    ...
    componentDidMount() {
      api('api/Mon/LayCategory/ComBoNhieuNguoi', 'GET', null).then(res => {
...
export default connect(mapStateToProps, mapDispatchToProps)(ComboNhieuNg);;
