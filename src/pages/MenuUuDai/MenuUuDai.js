...
class MenuUuDai extends Component {
  ...
  constructor(props){
    ...
    componentDidMount() {
      api('api/Mon/LayCategory/Menu UuDai', 'GET', null).then(res => {
...
export default connect(mapStateToProps, mapDispatchToProps)(MenuUuDai);;
